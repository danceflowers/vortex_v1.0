...
class alignas(VL_CACHE_LINE_BYTES) Vvortex_afu_shim_VX_result_if__Tz99 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vvortex_afu_shim_VX_result_if__Tz99(Vvortex_afu_shim__Syms* symsp, const char* v__name);
