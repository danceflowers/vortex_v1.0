...
module tc_mul_pipe #(
        ...
        output  [EXPWIDTH+PRECISION*2:0]      result_extend_o,
    ...
    //ctrl reg
    reg  [`XLEN_FP22-1:0] ctrl_c_reg1          ;
    reg  [2:0]                   ctrl_rm_reg1         ;

    reg  [`XLEN_FP22-1:0] ctrl_c_reg2          ;
    ...
    wire [EXPWIDTH:0]           s3_out_to_fadd_fp_prod_exp     ;
    ...
    assign  result_extend_o = {s3_out_to_fadd_fp_prod_sign,s3_out_to_fadd_fp_prod_exp,s3_out_to_fadd_fp_prod_sig};
endmodule
