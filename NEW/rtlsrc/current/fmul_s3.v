...
module fmul_s3 #(
        ...
        output [EXPWIDTH:0]             to_fadd_fp_prod_exp_o    ,
    ...
    assign to_fadd_fp_prod_exp_o  = special_case_haszero ? 'd0 : exp_pre_round -6'd15 +6'd31;                                                                                   ;
    assign to_fadd_fp_prod_sig_o  = special_case_haszero ? 'd0 : (sig_shifted[PRECISION*3:PRECISION+2] | {{(2*PRECISION-2){1'b0}},(|sig_shifted[PRECISION+1:0])});      //todo:后面检查位宽
