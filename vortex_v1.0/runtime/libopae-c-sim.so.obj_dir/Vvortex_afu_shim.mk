...
default: /mnt/d/wode_code_trunk/vortex/runtime/opae/../libopae-c-sim.so
...
VM_USER_CFLAGS = \
	-std=c++17 -Wall -Wextra -Wfatal-errors -Wno-array-bounds -fPIC -Wno-maybe-uninitialized -I/mnt/d/wode_code_trunk/vortex/sim/opaesim -I/mnt/d/wode_code_trunk/vortex/hw -I/mnt/d/wode_code_trunk/vortex/sim/common -I/mnt/d/wode_code_trunk/vortex/runtime/opae/.. -I//mnt/d/wode_code_trunk/vortex/third_party/softfloat/source/include -I/mnt/d/wode_code_trunk/vortex/third_party/ramulator/ext/spdlog/include -I/mnt/d/wode_code_trunk/vortex/third_party/ramulator/ext/yaml-cpp/include -I/mnt/d/wode_code_trunk/vortex/third_party/ramulator/src -DXLEN_32  -O2 -DNDEBUG -DNOPAE \
...
VM_USER_DIR = \
	...
	/mnt/d/wode_code_trunk/vortex/sim/opaesim \
...
util.o: /mnt/d/wode_code_trunk/vortex/sim/common/util.cpp 
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST)  -c -o $@ $<
fpga.o: /mnt/d/wode_code_trunk/vortex/sim/opaesim/fpga.cpp 
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST)  -c -o $@ $<
opae_sim.o: /mnt/d/wode_code_trunk/vortex/sim/opaesim/opae_sim.cpp 
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST)  -c -o $@ $<

### Link rules... (from --exe)
/mnt/d/wode_code_trunk/vortex/runtime/opae/../libopae-c-sim.so: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a $(VM_HIER_LIBS)
