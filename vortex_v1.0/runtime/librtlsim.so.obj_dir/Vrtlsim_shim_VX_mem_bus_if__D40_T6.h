...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_mem_bus_if__D40_T6 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrtlsim_shim_VX_mem_bus_if__D40_T6(Vrtlsim_shim__Syms* symsp, const char* v__name);
