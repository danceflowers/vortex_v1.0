...
VORTEX_HOME ?= /mnt/d/wode_code_trunk/vortex

XLEN ?= 32
EXT_TCU_ENABLE ?= 1

TOOLDIR ?= /home/chenbangyu/tools

OSVERSION ?= ubuntu/focal

INSTALLDIR ?= /mnt/d/wode_code_trunk/vortex
...
ifeq ($(EXT_TCU_ENABLE),1)
override CONFIGS += -DEXT_TCU_ENABLE
endif
