...
public:
  ...
  bool write_packet(uint32_t handle, uint32_t packet_idx, const TmemPacket& in);
  ...
  bool try_acquire_read_packet(uint64_t cycle, uint32_t handle, uint32_t packet_idx);
  bool try_acquire_meta_read_packet(uint64_t cycle, uint32_t handle, uint32_t packet_idx);
  bool try_acquire_write_packet(uint64_t cycle, uint32_t handle, uint32_t packet_idx);
